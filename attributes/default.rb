...
default['ovh_the_bastion']['config']['fanciness'] = 'full'
...
default['ovh_the_bastion']['config']['ingressRequirePIV'] = false
...
default['ovh_the_bastion']['config']['TOTPProvider'] = 'google-authenticator'
...
default['ovh_the_bastion']['config']['interactiveModeProactiveMFAenabled'] = true
default['ovh_the_bastion']['config']['interactiveModeProactiveMFAexpiration'] = 900
